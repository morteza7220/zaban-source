...
<div class="overflow-scroll bg-gradient-to-tl from-sky-400 via-cyan-300 to-slate-100">
   ...
   mx-auto gap-3">
    ...
    <div v-for="(value,key) in words_welcome" class="cards" @click="go($event)">
            <!-- front -->
          <div class="card front" style="color: red" v-if="key.length>7">{{key}}</div>
...
<RouterLink to="/paye70index">
      <img class="h-[5vh] w-[10vw] fixed bottom-30 right-1" src="@/assets/zaban/back2.png" />
</RouterLink> <br>
</div>
</template>
