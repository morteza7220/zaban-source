...
معلم: نرگس, تولد تو کی هست؟
نرگس: در ماه مهر است.
معلم: واقعا!! (راستی) تو چند سال داری؟ (چند سالته)
نرگس: من ۱۲ ساله هستم.
معلم: تو چطور, طاهره؟
طاهره: تولد من در ...... هست.(جای خالی هر ماهی میشه قرار داده مثل فروردین یا اذر Farvardin |  Azar) 
<img src="@/assets/paye_images/paye7/7_3.jpg">
